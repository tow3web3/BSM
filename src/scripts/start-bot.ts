// Script to start the Telegram bot in polling mode for local testing
...
bot.command('help', async (ctx) => {
  ...
  await ctx.reply(
    ...
    `*Messages:*\n` +
    `/inbox - View recent messages (last 5)\n` +
...
// Link wallet command - Generate verification code
...
// Inbox command with better formatting
